# FUuncion que no recibe parametros
def saludar():
...
# Si queremos que un parametro se opcional de dar su valor, le
# podemos definir el valor Predeterminado al momeno de definir la funcion
...
# el parametro *args arguments es una lista denamiva de elementos
