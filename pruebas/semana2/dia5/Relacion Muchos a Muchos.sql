...
select alum_nom,cur_nom from t_alumno
inner join t_alumno_curso on t_alumno.alum_id = t_alumno_curso.alum_id
inner join t_curso on t_curso.cur_id = t_alumno_curso.cur_id;
...
select alum_nom as Nombre, alum_ape as Apellido, cur_nom as Curso from t_alumno_curso as Puente
inner join t_alumno as Alumno on Alumno.alum_id = Puente.alum_id
inner join t_curso as Curso on Curso.cur_id = Puente.cur_id;
